...
in
{
  ...
  systemd.network = {
    ...
    networks.wg0 = {
      ...
      address = [ "192.168.128.1/24" "fd49:1279:1d2e:5063::1/64" ];
      networkConfig = {
        IPMasquerade = "both";
      };
    };
