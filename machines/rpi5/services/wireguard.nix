    ...
    systemd.network = {
        ...
        "50-wg0" = {
          ...
          wireguardPeers = [
            ...
            }
            {
              ...
              PublicKey = "Cc7kMxId0ogkFIHI+AWt7oCi/VXrui+7sklDY1UibU0=";
            }
            {
              AllowedIPs = [
                "192.168.128.5/32"
              ...
              PersistentKeepalive = 25;
              PresharedKeyFile = config.sops.secrets."wireguard/rpi5/psk-4".path;
              PublicKey = "7+ke0GxXJ9u/GGp0KUKTtywPPnYby62JBdDZWH8xNxQ=";
            }
          ];
        };
        "51-wg1" = {
      ...
      networks = {
        wg0 = {
          ...
          address = [
            (myVpn.ipv4.address + "/" + myVpn.ipv4.cidr)
            (myVpn.ipv6.address + "/" + myVpn.ipv6.cidr)
          ];
        };
        wg1 = {
          ...
          addresses = [
            {
              Address = supportVpn.ipv4.address + "/" + supportVpn.ipv4.cidr;
        ...
        wg2 = {
          ...
          address = [
            (netflixVpn.ipv4.address + "/" + netflixVpn.ipv4.cidr)
            (netflixVpn.ipv6.address + "/" + netflixVpn.ipv6.cidr)
          ];
        };
      };
    };
